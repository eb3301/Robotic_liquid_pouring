...
def generate_sim(parameters, view=False, liq=True, debug=False, video=False, approach=False):    
    ...
    if approach:
        ...
        liqpos = (parameters['pos_grip_ee'][0]+parameters['offset'][0],parameters['pos_grip_ee'][1]+parameters['offset'][2], parameters['pos_grip_ee'][2]+parameters['offset'][1]+container_size[2]+liquid_height/2)
